...
namespace Ivony.Html
{
  ...
  public static class Regulars
  {
    ...
    public static readonly string extraExpressionPattern = string.Format( CultureInfo.InvariantCulture, "(?<extra>(?<relative>{0})(?<rightSelector>{1}))", relativeExpressionPatternNoGroup, elementExpressionPatternNoGroup );
