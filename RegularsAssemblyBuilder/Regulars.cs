...
namespace RegularsAssemblyBuilder
{
  ...
  public static class Regulars
  {
    ...
    public static readonly string tagNamePattern = @"(?<tagName>[a-zA-Z][\w:_\-\.]*)";
    ...
    public static readonly string attributePattern = @"(?<attribute>#attrName#attrValue)\s*".Replace( "#attrName", attributeNamePattern ).Replace( "#attrValue", attributeValuePattern );
